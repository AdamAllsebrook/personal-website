...
<CodeBlock name="artists.csv" lang="" code={`id,name,spotify_uri
...
<CodeBlock name="artist.db" lang="sql" code={`CREATE TABLE artist (
...
<CodeBlock name="get_channel_1.py" lang="py" code={`import pandas as pd
import argparse
import time
import random
import sqlite3
...
<CodeBlock lang="py" code={`def get_many_channels(df):
    df[YOUTUBE] = ''
...
<CodeBlock lang="py" code={`    df[YOUTUBE] = df.apply(get_channel, axis=1)
`} />
with this:
<CodeBlock lang="py" code={`    df = get_many_channels(df)
`} />
...
<CodeBlock lang="" code={`> cat artists.csv | grep Weeknd
3,The Weeknd,spotify:artist:1Xyo4u8uXC1ZmMpatF05PJ
`} />
...
<CodeBlock name="get_channel_3.py" lang="py" code={`import argparse
import time
import random
import sqlite3
...
<CodeBlock lang="bash" code={`cat artists.csv \
...
<CodeBlock lang="bash" code={`sudo apt install parallel
`} />

Running parallel typically looks like this:

<CodeBlock lang="" code={`parallel <args> <command to run in parallel>
`} />
...
<CodeBlock lang="" code={`106,"Tyler, The Creator",spotify:artist:4V8LLVI7PbaPR0K2TGSxFF
`} />
...
<CodeBlock name="to_sql.py" lang="py" code={`import pandas as pd
import sys
...
<CodeBlock name="get_channel.py" lang="py" code={`import sys
import pandas as pd
import time
import random
